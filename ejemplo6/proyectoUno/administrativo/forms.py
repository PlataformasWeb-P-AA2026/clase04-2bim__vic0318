...
class NumeroTelefonicoForm(ModelForm):
    class Meta:
        ...
        labels = {
            'telefono': _('Ingrese el numero por favor'),
            'tipo': _('Ingrese el tipo por favor'),
            'estudiante': _('Ingrese al estudiante que corresponda'),
        }
...
class ComentarioForm(ModelForm):
    class Meta:
        ...
        labels = {
            'usuario': _('Ingrese su usuario por favor'),
            'comentario': _('Ingrese el comentario por favor'),
        }
